            ...
            <div class="container">
                ...
                {{-- <div class="col border-start border-4 border-danger" style="color: #dc3545"> --}}
                    ...
                    <h1 class="text-center">Di Website <br><strong style="color: #dc3545">Himpunan Mahasiswa <br> --}}
                        <h1 class="text-center"><strong style="color: #ffffff; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">Selamat Datang di</strong></h1>
                        <h1 class="text-center"><strong style="color: #dc3545; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">Website Himpunan Mahasiswa</strong></h1>
                        <h1 class="text-center"><strong style="color: #ffffff; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">
                            Teknik Informatika Universitas Pamulang
                        </strong></h1>
                        <h6 class="hidden-text-hero text-center" style="color: #ffffff; text-shadow: 4px 4px 4px rgba(0, 0, 0, 0.2);">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-4">
                            <div class="profile-card-4 text-center" onclick="window.location.href='/bph';" style="cursor: pointer;">
                                <img src="{{ asset('assets/images/pdd.jpg') }}" class="img img-fluid img-responsive" alt="Your Department (500x250)">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="profile-card-4 text-center" onclick="window.location.href='/bph';" style="cursor: pointer;">
                                <img src="{{ asset('assets/images/ristek.jpg') }}" class="img img-fluid img-responsive" alt="Your Department (500x250)">
                                <div class="profile-content">
                                    <div class="profile-description">
                                        <h4>Departemen</h4>
                                        <h4>RISTEK</h4>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="profile-card-4 text-center" onclick="window.location.href='/bph';" style="cursor: pointer;">
                                <img src="{{ asset('assets/images/humas.jpg') }}" class="img img-fluid img-responsive" alt="Your Department (500x250)">
                                <div class="profile-content">
                                    <div class="profile-description">
                                        <h4>Departemen</h4>
                                        <h4>HUMAS</h4>
             ...
             <div class="carousel-item active">
                <div class="container" data-aos="zoom-in-up">
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-4">
                            <div class="profile-card-4 text-center" onclick="window.location.href='/bph';" style="cursor: pointer;">
                                <img src="{{ asset('assets/images/bph.jpg') }}" class="img img-fluid img-responsive" alt="Your Department (500x250)">
                                <div class="profile-content">
                                    <div class="profile-description">
                                        <h4>Departemen</h4>
                                        <h4>BPH</h4>
                        ...
                        <!-- Add more cards here -->
                         ...
                         <div class="col-lg-4 col-md-4">
                            <div class="profile-card-4 text-center" onclick="window.location.href='/bph';" style="cursor: pointer;">
                                <img src="{{ asset('assets/images/sosbud.jpg') }}" class="img img-fluid img-responsive" alt="Your Department (500x250)">
                                <div class="profile-content">
                                    <div class="profile-description">
                                        <h4>Departemen</h4>
                                        <h4>SOSBUD</h4>
                        ...
                        <!-- Add more cards here -->
                         ...
                         <div class="col-lg-4 col-md-4">
                            <div class="profile-card-4 text-center" onclick="window.location.href='/bph';" style="cursor: pointer;">
                                <img src="{{ asset('assets/images/psda.jpg') }}" class="img img-fluid img-responsive" alt="Your Department (500x250)">
                                <div class="profile-content">
                                    <div class="profile-description">
                                        <h4>Departemen</h4>
                                        <h4>PSDA</h4>
        ...
        <div class="row py-5">
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4" data-aos="flip-down">
                        <img src="{{ asset('assets/images/hpc.png') }}" class="img-fluid mb-3 img-outline-berita" alt="">
             ...
             <div class="row justify-content-center" style="margin-top: 10px">
                    <!-- Teks di sebelah kiri gambar -->
                    <div class="col-lg-4" data-aos="flip-down">
                        <img src="{{ asset('assets/images/Rudistif.JPG') }}" class="img-fluid mb-3 img-outline-berita" alt="">
                        {{-- <div class="konten-berita">
                        </div> --}}
                    </div>
                    <div class="col-lg-4" data-aos="flip-down">
             ...
             <div class="row justify-content-center" style="margin-top: 10px">
                    <!-- Teks di sebelah kiri gambar -->
                    <div class="col-lg-4" data-aos="flip-down">
                        <img src="{{ asset('assets/images/podcast.png') }}" class="img-fluid mb-3 img-outline-berita" alt="">
                        {{-- <div class="konten-berita">
                        </div> --}}
                    </div>
                    <div class="col-lg-4" data-aos="flip-down">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                <img
                src="{{ asset('assets/images/rdt1.png') }}"
                class="w-100 shadow-1-strong rounded mb-4"
                alt="Boat on Calm Water"
                />

                <img
                src="{{ asset('assets/images/r2.jpg') }}"
                class="w-100 shadow-1-strong rounded mb-4"
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
                <img
                src="{{ asset('assets/images/mhs12.png') }}"
                class="w-100 shadow-1-strong rounded mb-4"
                alt="Mountains in the Clouds"
                />

                <img
                src="{{ asset('assets/images/2hima.JPG') }}"
                class="w-100 shadow-1-strong rounded mb-4"
                alt="Boat on Calm Water"
                />
            </div>
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
                <img
                src="{{ asset('assets/images/jggl2.png') }}"
                class="w-100 shadow-1-strong rounded mb-4"
                alt="Waves at Sea"
                />

                <img
                src="{{ asset('assets/images/Rudistif.JPG') }}"
                class="w-100 shadow-1-strong rounded mb-4"
